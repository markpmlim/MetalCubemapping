...
class EquiRectagularRenderer: NSObject, MTKViewDelegate {
    ...
    */
        ...
        let url = bundle.url(forResource: "equirectImage",   //uffizi_512 newport_loft
                             withExtension: "hdr")
    ...
    /*
     ...
     The origin of the texture coordinates is at the upper-left corner of
      the quad (which is a square) with the u-axis pointing right and
      the v-axis pointing vertically downwards.
     The pixel coordinates of Metal also starts as the upper-left corner.

     The six 2D sub-textures of a cubemap texture are flipped horizontally.
    ...
    func createCubemapTexture_RH() {
        ...
        // The +X, -X, +Z and -Z faces are generated wrongly.
