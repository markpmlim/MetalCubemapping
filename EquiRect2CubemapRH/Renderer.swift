...
class Renderer: NSObject, MTKViewDelegate {
    ...
    func createCubemapTexture_RH() {
        ...
        // The +X, -X, +Z and -Z faces were generated in the wrong order
        //   in the previous iteration of this demo. (cf. Readme.md)
        // The +Y and -Y faces were generated correctly but the orientations were wrong.
