...
b) They are converted into instances of *MTLTextures* (of type *MTLTextureType2D*) using the *MTKTextureLoader* function
...
An offscreen renderer is called to convert the six 2D textures to a 1:1 EquiRectangular projection (aka Spherical Projection) map.
...
This demo converts an EquiRectangular image (2:1) to six 2D images by rendering to an off-screen cubemap texture (of the type *MTLTextureTypeCube*)
