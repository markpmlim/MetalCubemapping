...
It applies the concept of layer rendering in Metal to create a cubemap texture which will be displayed as a background environment map.
...
This demo loads and instantiates a MTLTexture of type MTLTextureTypeCube from 6 *.hdr* files located in the *Images* folder of this project. Three sets of *.hdr* files are provided; the sets have been converted from the files *before.hdr*, *equirectImage.hdr* and *newport_loft.hdr*.
...
Once the view is displayed, the user may save the six 2D images generated by this Metal application to disk by pressing "s" or "S". He/she can visually compare the six 2D images (*.hdr*) with those within the "Images" folder of this project. Some of the images within this folder were obtained by running the WebGL program at the link:
